...
class PDF_Builder_Company():
    ...
    '''
    def __init__(self,job_num,base_directory):
        super().__init__()
    ...
    def parts_read_in(self):
        ...
        parts_data=[
                    ...
                    r'\begin{longtable}{@{\extracolsep{\fill}}llp{9cm}rrr@{\extracolsep{\fill}}}',
                    r'\toprule',
                    r'Qty & Part Number & Description & Cost & Price & Extension\\* \midrule',
                    r'\endhead'
                    ]
...
class PDF_Builder_Customer():
    ...
    def parts_read_in(self):
        ...
        parts_data=[
                    r'\setlength\LTleft{0pt}',
                    r'\setlength\LTright{0pt}',
                    r'\begin{longtable}{@{\extracolsep{\fill}}llp{10cm}rr@{\extracolsep{\fill}}}',
                    r'\toprule',
                    r'Qty & Part Number & Description & Price & Extension\\* \midrule',
                    r'\endhead'
                    ]
        for i in range(len(p_data)):
            dat=p_data[i].split(sep=',')[0:6]
...
#    info=PDF_Builder_Company(456,
#                     os.path.join(os.environ['USERPROFILE'],'BEI_Invoices'))
    info=PDF_Builder_Customer(456,
                     os.path.join(os.environ['USERPROFILE'],'BEI_Invoices'))      